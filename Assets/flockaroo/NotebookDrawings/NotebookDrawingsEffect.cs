...
public class NotebookDrawingsEffect : MonoBehaviour {
    ...
    void initAll(int width, int height)
    {
        ...
        shaders["Image"] = createShaderOptSuff("flockaroo_NotebookDrawings/Image",defineModeSuffixes);
        ...
        shaders["Buff_A"] = createShaderOptSuff("flockaroo_NotebookDrawings/Buff_A",defineModeSuffixes);
    ...
    private void OnRenderImage(RenderTexture src, RenderTexture dest) {
        ...
        {
            Debug.Log("NotebookDrawings 1st init (or Resolution changed)");
        ...
        foreach( string buffName in bufferOrder )
        {
            ...
            mat.SetFloat("CamMotion",CamMotion);
            mat.SetFloat("ColorIntensity",ColorIntensity);
            mat.SetFloat("ColorSpread",ColorSpread);
            mat.SetFloat("Lines",Lines);
            mat.SetFloat("LinesDist",LinesDist);
            mat.SetFloat("LinesVert",LinesVert);
            ...
            mat.SetFloat("PencilSize",PencilSize);
            mat.SetFloat("StrokeAngle",StrokeAngle);
            mat.SetFloat("StrokeBend",StrokeBend);
            mat.SetFloat("StrokeNum",StrokeNum);
            mat.SetFloat("StrokeOffs",StrokeOffs);
