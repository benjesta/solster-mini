...
//[AddComponentMenu("Image Effects/Artistic/NotebookDrawings")]
[Serializable, VolumeComponentMenu("Post-processing/Custom/Flockaroo/NotebookDrawings")]
public sealed class NotebookDrawingsEffectHDRP : CustomPostProcessVolumeComponent, IPostProcessComponent {
    ...
    public ClampedFloatParameter CamMotion = new ClampedFloatParameter(1.000000f, 0.0f, 1.0f);
    public ClampedFloatParameter ColorIntensity = new ClampedFloatParameter(0.745000f, 0.0f, 1.0f);
    public ClampedFloatParameter ColorSpread = new ClampedFloatParameter(1.000000f, 0.0f, 1.0f);
    public ClampedFloatParameter Lines = new ClampedFloatParameter(1.000000f, 0.0f, 1.0f);
    public ClampedFloatParameter LinesDist = new ClampedFloatParameter(0.200000f, 0.0f, 1.0f);
    public ClampedFloatParameter LinesVert = new ClampedFloatParameter(1.000000f, 0.0f, 1.0f);
    public ClampedFloatParameter MasterFade = new ClampedFloatParameter(0.0f, 0.0f, 1.0f);
    public ClampedFloatParameter Noise = new ClampedFloatParameter(1.000000f, 0.0f, 1.0f);
    public ClampedFloatParameter NumSamples = new ClampedFloatParameter(16.000000f, 0.0f, 32.0f);
    public ColorParameter PaperTint = new ColorParameter(new Color(1.000000f,0.980000f,0.950000f) );
    public ClampedFloatParameter PencilSize = new ClampedFloatParameter(0.220000f, 0.0f, 1.0f);
    public ClampedFloatParameter StrokeAngle = new ClampedFloatParameter(0.000000f, 0.0f, 6.4f);
    public ClampedFloatParameter StrokeBend = new ClampedFloatParameter(1.000000f, -1.0f, 1.0f);
    public ClampedFloatParameter StrokeNum = new ClampedFloatParameter(3.000000f, 0.0f, 10.0f);
    public ClampedFloatParameter StrokeOffs = new ClampedFloatParameter(0.000000f, 0.0f, 5.0f);
    public ClampedFloatParameter StrokeSpread = new ClampedFloatParameter(0.000000f, 0.0f, 1.0f);
    ...
    void initAll(int width, int height)
    {
        ...
        shaders["Image"] = createShaderOptSuff("flockaroo_NotebookDrawings/ImageHDRP",defineModeSuffixes);
        textureCh["Image"][0] = "Ref:Buff_A:Tex0";
        ...
        shaders["Buff_A"] = createShaderOptSuff("flockaroo_NotebookDrawings/Buff_AHDRP",defineModeSuffixes);
    ...
    public override void Render(CommandBuffer cmd, HDCamera camera, RTHandle src_h, RTHandle dest_h) {
        ...
        if(gammaShader==null) gammaShader = createShader("flockaroo_NotebookDrawings/GammaCorrectShader");
        ...
        foreach( string buffName in bufferOrder )
        {
            ...
            mat.SetFloat("CamMotion",CamMotion.value);
            mat.SetFloat("ColorIntensity",ColorIntensity.value);
            mat.SetFloat("ColorSpread",ColorSpread.value);
            mat.SetFloat("Lines",Lines.value);
            mat.SetFloat("LinesDist",LinesDist.value);
            mat.SetFloat("LinesVert",LinesVert.value);
            ...
            mat.SetFloat("PencilSize",PencilSize.value);
            mat.SetFloat("StrokeAngle",StrokeAngle.value);
            mat.SetFloat("StrokeBend",StrokeBend.value);
            mat.SetFloat("StrokeNum",StrokeNum.value);
            mat.SetFloat("StrokeOffs",StrokeOffs.value);
