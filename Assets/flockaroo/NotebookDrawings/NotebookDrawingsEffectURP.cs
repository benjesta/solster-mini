...
public class NotebookDrawingsEffectURP : ScriptableRendererFeature {
    ...
    public class EffectSettings
    {
        ...
        [Range(0.0f, 1.0f)]
        public float CamMotion = 1.000000f;
        [Range(0.0f, 1.0f)]
        public float ColorIntensity = 0.745000f;
        [Range(0.0f, 1.0f)]
        public float ColorSpread = 1.000000f;
        [Range(0.0f, 1.0f)]
        public float Lines = 1.000000f;
        [Range(0.0f, 1.0f)]
        public float LinesDist = 0.200000f;
        [Range(0.0f, 1.0f)]
        public float LinesVert = 1.000000f;
        [Range(0.0f, 1.0f)]
        public float MasterFade = 1.0f;
        [Range(0.0f, 1.0f)]
        public float Noise = 1.000000f;
        [Range(0.0f, 32.0f)]
        public float NumSamples = 16.000000f;
        public Color PaperTint = new Color(1.000000f,0.980000f,0.950000f);
        [Range(0.0f, 1.0f)]
        public float PencilSize = 0.220000f;
        [Range(0.0f, 6.4f)]
        public float StrokeAngle = 0.000000f;
        [Range(-1.0f, 1.0f)]
        public float StrokeBend = 1.000000f;
        [Range(0.0f, 10.0f)]
        public float StrokeNum = 3.000000f;
        [Range(0.0f, 5.0f)]
        public float StrokeOffs = 0.000000f;
        [Range(0.0f, 1.0f)]
        public float StrokeSpread = 0.000000f;
        [Range(0.0f, 1.0f)]
    ...
    public void Render(CommandBuffer cmd, RenderTexture src, RenderTexture dest) {
        ...
        foreach( string buffName in bufferOrder )
        {
            ...
            mat.SetFloat("CamMotion",s.CamMotion);
            mat.SetFloat("ColorIntensity",s.ColorIntensity);
            mat.SetFloat("ColorSpread",s.ColorSpread);
            mat.SetFloat("Lines",s.Lines);
            mat.SetFloat("LinesDist",s.LinesDist);
            mat.SetFloat("LinesVert",s.LinesVert);
            ...
            mat.SetFloat("PencilSize",s.PencilSize);
            mat.SetFloat("StrokeAngle",s.StrokeAngle);
            mat.SetFloat("StrokeBend",s.StrokeBend);
            mat.SetFloat("StrokeNum",s.StrokeNum);
            mat.SetFloat("StrokeOffs",s.StrokeOffs);
    ...
    {
        m_ScriptablePass = new EffectRenderPass("FlockarooNotebookDrawings",ref settings,settings.WhenToApply);
